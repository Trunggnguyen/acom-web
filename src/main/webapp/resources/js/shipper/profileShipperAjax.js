$(document).ready(function(){
	...
	$('.btnCapNhatThongTin').on("click", function(event) {
		...
		var href = "http://localhost:8080/acom/api/profile/"+nguoiDungId;
