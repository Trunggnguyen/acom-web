...
<html>
	...
	<div class="row">
		...
		<p>Vào lúc ${donhang.getNgayDatHang()} chúng tôi đã nhận được đơn đặt hàng với những sản phẩm như sau:</p><br>
					...
					<c:forEach items="${cart}" var="sanpham" >
					 ...
					 <tr style="text-align: center;">
						    <td>
						    	<img src="/acom/img/${sanpham.id}.png" alt="not found img" class="img-reponsive fix-size-img">
						    </td>
		...
		<p>Acom xin chân thành cảm ơn quý khách hàng đã tin tưởng sử dụng dịch vụ, sản phẩm của chúng tôi</p><br>
